...
export const createNginxAndVectorECRImages = (scope: Construct, platform: Platform) => {
...
export const createNginxLuaECRImage = (scope: Construct, platform: Platform) => {
...
export const createJavaServerECRImage = (scope: Construct, platform: Platform) => {
...
export const createNginxLogECRImage = (scope: Construct, platform: Platform) => {

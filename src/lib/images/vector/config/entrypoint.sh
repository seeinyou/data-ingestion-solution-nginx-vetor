...
#TLS
export AWS_MSK_AUTH_TLS_ENABLE=true
...
echo "VECTOR_THREADS: $VECTOR_THREADS"
...
echo "/usr/local/bin/vector ${configs} --require-healthy $VECTOR_REQUIRE_HEALTHY --threads ${VECTOR_THREADS}"
/usr/local/bin/vector ${configs} --require-healthy $VECTOR_REQUIRE_HEALTHY --threads ${VECTOR_THREADS}

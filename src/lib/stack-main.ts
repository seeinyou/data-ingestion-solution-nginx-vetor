...
import { IngestServerConstruct } from "./consturct-ingest-server";
import { fromProvidedBucket } from "./s3";

import { setUpVpc } from "./vpc";
import { getExistingMskConfig, getExistingStreamName } from "./util";
...
export class ServerIngestionStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: ServerIngestionStackProps) {
    ...
    const certificateArn =
      props.certificateArn || AppConfig.getCertificateArn(this);
    ...
    new cdk.CfnOutput(this, "AlbDns", {
      value: ingestServer.alb.loadBalancerDnsName,
